...
async function loadProduct() {
    ...
    for (i = 0; i < list.length; i++) {
        main += `<tr>
                    ...
                    <td>${formatmoney(list[i].oldPrice)}</td>
...
//    var id = uls.searchParams.get("id");
//
//    var url = 'http://localhost:8080/api/product/admin/create-update';
...
//            "oldPrice": document.getElementById("giacu").value,
//            "unit": document.getElementById("donvitinh").value,
//            "expiry": document.getElementById("hansudung").value,
//            "description": tinyMCE.get('editor').getContent(),
//            "quantity": document.getElementById("quantity").value,
//            "category": {
//                "id":document.getElementById("listdpar").value
//            },
//        },
